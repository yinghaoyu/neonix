...
interrupt_entry:
  ...
  push fs
  push gs
  pusha ; eax, ecx, edx, ebx, esp, ebp, esi, edi依次压栈
  ...
  ; 调用中断处理函数, handler_table 中存储了中断处理函数指针
...
INTERRUPT_HANDLER 0x20, 0; clock 时钟中断, 外中断
